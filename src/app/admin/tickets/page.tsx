...
export default function AdminTicketsPage() {
  ...
  const isLoading = areTicketsLoading || areEventsLoading;
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <TicketIcon className="h-5 w-5 text-primary" /> Ticket Details
            </DialogTitle>
              ...
              <div className="border-t pt-4 space-y-2">
                ...
                <div className="grid grid-cols-2 gap-4 text-xs">
                  ...
                  {selectedTicket.scans > 0 && selectedTicket.lastScannedAt && (
                    <div className="col-span-2 flex items-center text-muted-foreground gap-1">
